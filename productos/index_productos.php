...
<head>
    ...
    <title>Inicio</title>
    <link rel="icon" type="image/x-icon" href="../img/logo-transparente.png">
    ...
    <div class="d-flex mt-3">
        ...
        <div class="col-md-6 mt-2">
            ...
            <div class="text-center mt-5">
                ...
                <div class="">
                    <div class="mt-3">
                        <a href="vista/fm_alta_categorias.php" class="btn btn-primary" style="width: 30%;">
                            <i class="fas fa-user-plus"></i>
                            Ingresar Categoria
                        </a>
                    </div>
                    <div class="mt-3">
                        <a href="vista/listado_categorias.php" class="btn btn-secondary" style="width: 30%;">
                            <i class="fas fa-list"></i>
                            Listado Categoria
                        </a>
                    </div>
                    <div class="mt-3">
                        <a href="vista/fm_consultarID_categorias.php?accion=borrar" class="btn btn-danger" style="width: 30%;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-dash-fill" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M11 7.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5" />
                                <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
                    ...
                    <div class="mt-3">
                        <a href="vista/fm_consultarID_categorias.php?accion=modificar" class="btn btn-success" style="width: 30%;">
                            <i class="fas fa-edit"></i>
                            Modificar Categoria
                        </a>
                    </div>
                    <div class="mt-3 sm">
                        <a href="vista/fm_consultas_categorias.php?accion=consulta" class="btn btn-warning text-secondary" style="width: 30%;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-search-heart" viewBox="0 0 16 16">
                                <path d="M6.5 4.482c1.664-1.673 5.825 1.254 0 5.018-5.825-3.764-1.664-6.69 0-5.018" />
                                <path d="M13 6.5a6.47 6.47 0 0 1-1.258 3.844q.06.044.115.098l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1-.1-.115h.002A6.5 6.5 0 1 1 13 6.5M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11" />
                            </svg>
