        ...
        switch ($_POST['accion']) {
            case 'alta':
                ...
                if (empty($nombre) || empty($tasa_iva)) {
                    ...
                    echo '<br>';
                    echo '<a href="../vista/fm_alta_categorias.php"><button class="btn btn-primary w-25"><i class="fa-solid fa-arrow-left"></i>
                    Formulario</button></a>';
                } else {
            ...
            case 'actualizar':
                ...
                if (empty($nombre) || empty($tasa_iva)) {
                    ...
                    echo '<br>';
                    echo '<a href="../vista/fm_actualizar_categorias.php?id='.$id.'"><button class="btn btn-primary w-25"><i class="fa-solid fa-arrow-left"></i>
                    Formulario</button></a>';
                }else{
