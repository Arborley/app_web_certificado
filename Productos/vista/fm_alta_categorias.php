...
<body>
    ...
    <div class="">
        <div class="bg-white container mt-5 pb-3 card text-center card">
            <h2 class="mt-3">Insertar categoria</h2>
            <form action="../controlador/controlador_categorias.php" method="POST">
                ...
                <div class="form-group d-flex mt-3">
                    ...
                    <input type="text" id="nombre_cat" name="nombre_cat" class="form-control w-75" placeholder="Categoría">
                </div>
                <div class="form-group d-flex mt-3">
                    <label class="col-md-2" for="descripcion">Tasa IVA</label>
                    <input type="text" id="tasa" name="tasa" class="form-control w-75" placeholder="IVA">
                </div>
