...
<body>
    ...
    $modificarid = 'fm_actualizar_categorias.php';
    $borrarid = 'fm_eliminar_categorias.php';
    $consultarid = 'pantalla_datos.php'
    ...
    <div class="formulario container mt-5 border border-dark mb-3 text-center card">
        ...
        <form action="../controlador/controlador_categorias.php" method="POST">
            ...
            <div class="form-group">
                <label for="id" class="lead" ><strong>¿Qué categoria quieres usar?</strong></label>
